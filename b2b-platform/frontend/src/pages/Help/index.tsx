  ...
  const categories: FAQCategory[] = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer: 'После регистрации войдите в личный кабинет. В разделе "Компания" заполните подробную информацию о вашем бизнесе. Затем перейдите в раздел "Продукты и услуги" и нажмите "Добавить товар". Заполните описание, загрузите фотографии и укажите цены.'
        },
        {
